   ...
   try:
       ...
       if 'db_manager' not in st.session_state:
           try:
               ...
               # 메모리 DB로 폴백
               st.session_state.db_manager = AdvancedDuckDBManager(":memory:")
       ...
       if 'pdf_processor' not in st.session_state:
           st.session_state.pdf_processor = MaximumExtractorProcessor(
               st.session_state.ontology_manager
           )
       
       # 비교 시스템 초기화
       if 'comparison_system' not in st.session_state:
           st.session_state.comparison_system = CompleteComparisonSystem(
